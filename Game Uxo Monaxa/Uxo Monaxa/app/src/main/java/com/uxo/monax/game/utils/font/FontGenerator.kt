package com.uxo.monax.game.utils.font
...
class FontGenerator(fontPath: FontPath): FreeTypeFontGenerator(Gdx.files.internal(fontPath.path)) {
    ...
    companion object {
        enum class FontPath(val path: String) {
            RubikDoodleShadow ("font/RubikDoodleShadow-Regular.ttf"),
            SansitaOne        ("font/SansitaOne.ttf"),

            InterRegular("font/InterRegular.ttf"),
        }
    }
